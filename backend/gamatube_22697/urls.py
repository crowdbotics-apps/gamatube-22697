"""gamatube_22697 URL Configuration
...
admin.site.site_header = "gamatube"
admin.site.site_title = "gamatube Admin Portal"
admin.site.index_title = "gamatube Admin"

# swagger
api_info = openapi.Info(
    title="gamatube API",
    default_version="v1",
    description="API documentation for gamatube App",
)
